  ...
  module.exports = function(Connection, Transaction, Request, ConnectionError, TransactionError, RequestError) {
    ...
    TediousRequest = (function(_super) {
      ...
      /*
          ...
          Original Code: TediousRequest.prototype.query = function(command, callback) {
      */

      TediousRequest.prototype.query = function(command, callback, options) {
          ...
          return function(err, connection) {
            ...
            if (!err) {
              ...
              req.on('row', function(columns) {
                ...
                */
                if (!recordset && options.mode=="normal") {
                  recordset = [];
                }
                else if (!recordset && options.mode=="stream") {
                  recordset = 0;
                }
                /* 
                End of Edit
